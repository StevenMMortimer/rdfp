...
dfp_ProductTemplateService_object_factory <- function(obj_type, obj_data){
  ...
  if(obj_type=='ProductTemplateActionError'){
    stopifnot(all(sampled_names %in% c('reason')))
  }

  if(obj_type=='ProductTemplateError'){
    stopifnot(all(sampled_names %in% c('reason')))
  }

  if(obj_type=='ProductTemplatePage'){
...
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a createProductTemplatesResponse
#' @export
...
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a getProductTemplatesByStatementResponse
#' @export
...
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a updateProductTemplatesResponse
#' @export
