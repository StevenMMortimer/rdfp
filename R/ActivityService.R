...
#' contains.
#' 
#' ActivityService Object Factory
#' 
#' A function to create a variety of objects that are part of the ActivityService
...
#' \strong{Activity}
#' 
#' An activity is a specific user action that an advertiser wants to track,
#' such as the completion of a purchase or a visit to a webpage. You create and
#' manage activities in DFP. When a user performs the action after seeing an
#' advertiser's ad, that's a conversion. For example, you set up an activity in
#' DFP to track how many users visit an advertiser's promotional website after
#' viewing or clicking on an ad. When a user views an ad, then visits the page,
#' that's one conversion.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.Activity}{Google Documentation for Activity}
#' \describe{
#'  \item{id}{a integer -  The unique ID of the Activity. This value is readonly and is assigned by
#' Google.}
#'  \item{activityGroupId}{a integer -  The ID of the ActivityGroup that this Activity belongs to.}
#'  \item{name}{a string -  The name of the Activity. This attribute is required and has a maximum
#' length of 255 characters.}
#'  \item{expectedURL}{a string -  The URL of the webpage where the tags from this activity will be placed.
#' This attribute is optional.}
#'  \item{status}{a Activity.Status - The status of this activity. This attribute is readonly. This can take one of the following values:
#'    \itemize{
#'      \item{ACTIVE}
#'      \item{INACTIVE}
#'    }
#'   }
#'  \item{type}{a Activity.Type - The activity type. This attribute is optional and defaults to Activity.Type
#' PAGE_VIEWS This can take one of the following values:
#'    \itemize{
#'      \item{PAGE_VIEWS - Tracks conversions for each visit to a webpage. This is a counter type.}
#'      \item{DAILY_VISITS - Tracks conversions for visits to a webpage, but only counts one conversion
#' per user per day, even if a user visits the page multiple times. This is a
#' counter type.}
#'      \item{CUSTOM - Tracks conversions for visits to a webpage, but only counts one conversion
#' per user per user session. Session length is set by the advertiser. This is
#' a counter type.}
#'      \item{ITEMS_PURCHASED - Tracks conversions where the user has made a purchase, the monetary value of
#' each purchase, plus the number of items that were purchased and the order
#' ID. This is a sales type.}
#'      \item{TRANSACTIONS - Tracks conversions where the user has made a purchase, the monetary value of
#' each purchase, plus the order ID (but not the number of items purchased).
#' This is a sales type.}
#'      \item{IOS_APPLICATION_DOWNLOADS - Tracks conversions where the user has installed an iOS application. This is
#' a counter type.}
#'      \item{ANDROID_APPLICATION_DOWNLOADS - Tracks conversions where the user has installed an Android application. This
#' is a counter type.}
...
#' }
#' 
#' \strong{ActivityError}
#' 
#' Errors relating to Activity and Activity Group services.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.ActivityError}{Google Documentation for ActivityError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
#'  \item{reason}{a ActivityError.Reason - The error reason represented by an enum. This can take one of the following values:
#'    \itemize{
#'      \item{ACTIVITIES_FEATURE_REQUIRED - The 'activities' feature is required but not enabled.}
#'      \item{UNKNOWN - The value returned if the actual value is not exposed by the requested API
#' version.}
#'    }
#'   }
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.ActivityPage}{Google Documentation for ActivityPage}
#' \describe{
...
#'  \item{results}{a Activity -  The collection of activities contained within this page.}
#' }
#' 
#' \strong{ApiError}
#' 
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.ApiError}{Google Documentation for ApiError}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.ApiException}{Google Documentation for ApiException}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.ApiVersionError}{Google Documentation for ApiVersionError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.ApplicationException}{Google Documentation for ApplicationException}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.AuthenticationError}{Google Documentation for AuthenticationError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.BooleanValue}{Google Documentation for BooleanValue}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.CollectionSizeError}{Google Documentation for CollectionSizeError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.CommonError}{Google Documentation for CommonError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' 
#' Represents a date.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.Date}{Google Documentation for Date}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.DateTime}{Google Documentation for DateTime}
#' \describe{
#'  \item{date}{a Date}
#'  \item{hour}{a integer}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.DateTimeValue}{Google Documentation for DateTimeValue}
#' \describe{
#'  \item{extends Value}{see documentation for Value}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.DateValue}{Google Documentation for DateValue}
#' \describe{
#'  \item{extends Value}{see documentation for Value}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.FeatureError}{Google Documentation for FeatureError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' client.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.InternalApiError}{Google Documentation for InternalApiError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.NotNullError}{Google Documentation for NotNullError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.NumberValue}{Google Documentation for NumberValue}
#' \describe{
#'  \item{extends Value}{see documentation for Value}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.ObjectValue}{Google Documentation for ObjectValue}
#' \describe{
#'  \item{extends Value}{see documentation for Value}
#' }
#' 
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.ParseError}{Google Documentation for ParseError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.PermissionError}{Google Documentation for PermissionError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' object.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.PublisherQueryLanguageContextError}{Google Documentation for PublisherQueryLanguageContextError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' object.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.PublisherQueryLanguageSyntaxError}{Google Documentation for PublisherQueryLanguageSyntaxError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.QuotaError}{Google Documentation for QuotaError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.RangeError}{Google Documentation for RangeError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.RequiredError}{Google Documentation for RequiredError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.ServerError}{Google Documentation for ServerError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.SetValue}{Google Documentation for SetValue}
#' \describe{
#'  \item{extends Value}{see documentation for Value}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.SoapRequestHeader}{Google Documentation for SoapRequestHeader}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.SoapResponseHeader}{Google Documentation for SoapResponseHeader}
#' \describe{
...
#' StringParam.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.Statement}{Google Documentation for Statement}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.StatementError}{Google Documentation for StatementError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' type Value.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.String_ValueMapEntry}{Google Documentation for String_ValueMapEntry}
#' \describe{
#'  \item{key}{a string}
#'  \item{value}{a Value}
#' }
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.StringLengthError}{Google Documentation for StringLengthError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.TextValue}{Google Documentation for TextValue}
#' \describe{
#'  \item{extends Value}{see documentation for Value}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.UniqueError}{Google Documentation for UniqueError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
#' }
#' 
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ActivityService.Value}{Google Documentation for Value}
#' \describe{
#' }
#' 
#' 
#' 
#' @usage dfp_ActivityService_object_factory(obj_type, obj_data)
#' 
...
#' @export
dfp_ActivityService_object_factory <- function(obj_type, obj_data){
  ...
  if(obj_type=='Activity'){
    stopifnot(all(sampled_names %in% c('id', 'activityGroupId', 'name', 'expectedURL', 'status', 'type')))
  }

  if(obj_type=='ActivityError'){
    stopifnot(all(sampled_names %in% c('reason')))
  }

  if(obj_type=='ActivityPage'){
...
#' 
#' @usage dfp_createActivities(request_data)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a createActivitiesResponse
#' @export
dfp_createActivities <- function(request_data){

  request_body <- make_request_body(service='ActivityService', root_name='createActivities', data=request_data)
  request <- build_soap_request(body = request_body)

  response <- xmlChildren(xmlChildren(xmlChildren(xmlRoot(request))$Body)[['createActivitiesResponse']])$rval
...
#' }
#' 
#' @usage dfp_getActivitiesByStatement(request_data)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a getActivitiesByStatementResponse
#' @export
dfp_getActivitiesByStatement <- function(request_data){

  request_body <- make_request_body(service='ActivityService', root_name='getActivitiesByStatement', data=request_data)
  request <- build_soap_request(body = request_body)

  response <- xmlChildren(xmlChildren(xmlChildren(xmlRoot(request))$Body)[['getActivitiesByStatementResponse']])$rval
  response <- if(is.null(response)) NULL else xmlToList(response)
  return(response)
}
#' 
...
#' 
#' @usage dfp_updateActivities(request_data)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a updateActivitiesResponse
#' @export
dfp_updateActivities <- function(request_data){

  request_body <- make_request_body(service='ActivityService', root_name='updateActivities', data=request_data)
  request <- build_soap_request(body = request_body)

  response <- xmlChildren(xmlChildren(xmlChildren(xmlRoot(request))$Body)[['updateActivitiesResponse']])$rval
  response <- if(is.null(response)) NULL else xmlToList(response)
  return(response)
}
#' 
