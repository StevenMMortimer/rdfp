...
#' for the Geo target</td> </tr> <tr> <td>Name</td> <td>The name of the Geo
#' target</td> </tr> <tr> <td>CanonicalParentId</td> <td>The criteria ID of
#' the direct parent that defines the canonical name of the geo target. For
#' example, if the current geo target is "San Francisco", its canonical name
#' would be "San Francisco, California, United States" thus the
#' canonicalParentId would be the criteria ID of California and the
#' canonicalParentId of California would be the criteria ID of United states
#' </td> </tr> <tr> <td>ParentIds</td> <td>A comma separated list of criteria
#' IDs of all parents of the geo target ordered by ascending size</td> </tr>
#' <tr> <td>CountryCode</td> <td>Country code as defined by ISO 3166-1
#' alpha-2</td> </tr> <tr> <td>Type</td> <td>Allowable values: <ul>
#' <li>Airport</li> <li>Autonomous_Community</li> <li>Canton</li>
#' <li>City</li> <li>Congressional_District</li> <li>Country</li>
#' <li>County</li> <li>Department</li> <li>DMA_Region</li>
...
#' <h2>Bandwidth_Group</h2> <table> <tr> <th scope="col">Column Name</th> <th
#' scope="col">Description</th> </tr> <tr> <td>Id</td> <td>Unique identifier
#' for the bandwidth group</td> </tr> <tr> <td>BandwidthName</td> <td>Name of
#' the bandwidth group</td> </tr> </table> <h2>Browser</h2> <table> <tr> <th
#' scope = "col">Column Name</th> <th scope="col">Description</th> </tr> <tr>
#' <td>Id</td> <td>Unique identifier for the browser</td> </tr> <tr>
...
#' <h2>Browser_Language</h2> <table> <tr> <th scope = "col">Column Name</th>
#' <th scope="col">Description</th> </tr> <tr> <td>Id</td> <td>Unique
#' identifier for the browser language</td> </tr> <tr>
...
#' party company</td> </tr> </table> <h2
#' id="Line_Item">Line_Item</h2><table><tr><th>Column
#' name</th><th>Type</th><th>Description</th></tr><tr><td>CostType</td><td><code>Text</code></td><td>The
...
#' targeting criteria for the ad campaign.&lt;p&gt;&lt;b&gt;This object is
#' experimental!&lt;code&gt;Targeting&lt;/code&gt; is an experimental,
#' innovative, and rapidlychanging new feature for DFP. Unfortunately, being
#' on the bleeding edge means that we may makebackwards-incompatible changes
#' to&lt;code&gt;Targeting&lt;/code&gt;. We will inform the community when
#' this featureis no longer
...
#' reserved.</td></tr></table><h2
#' id="Ad_Unit">Ad_Unit</h2><table><tr><th>Column
#' name</th><th>Type</th><th>Description</th></tr><tr><td>AdUnitCode</td><td><code>Text</code></td><td>A
...
#' of the ad unit&#39;s parent. Every ad unit has a parent except for the root
#' ad unit, which is created by
...
#' belongs.</td></tr></table><h2 id="User">User</h2><table><tr><th>Column
#' name</th><th>Type</th><th>Description</th></tr><tr><td>Email</td><td><code>Text</code></td><td>The
...
#' id="Exchange_Rate">Exchange_Rate</h2><table><tr><th>Column
#' name</th><th>Type</th><th>Description</th></tr><tr><td>CurrencyCode</td><td><code>Text</code></td><td>The
#' currency code that the exchange rate is related to. The exchange rate is
#' between this currency and Network#currencyCode the network&#39;s currency.
#' This attribute is required for creation and then is
...
#' rate is from this currency to Network#currencyCode the network&#39;s
#' currency, or from Network#currencyCode the network&#39;s currency to this
#' currency. This attribute can be
...
#' id="Programmatic_Buyer">Programmatic_Buyer</h2><table><tr><th>Column
#' name</th><th>Type</th><th>Description</th></tr><tr><td>BuyerAccountId</td><td><code>Number</code></td><td>The
#' ID used by Adx to bill the appropriate buyer network for a programmatic
#' order.</td></tr><tr><td>Name</td><td><code>Text</code></td><td>Display name
#' that references the
#' buyer.</td></tr><tr><td>ParentId</td><td><code>Number</code></td><td>The ID
#' of the programmatic buyer&#39;s parent. If the programmatic buyer has no
#' parent, this field will be zero.</td></tr></table><h2
#' id="Audience_Segment_Category">Audience_Segment_Category</h2><table><tr><th>Column
#' name</th><th>Type</th><th>Description</th></tr><tr><td>Id</td><td><code>Number</code></td><td>The
...
#' id="Audience_Segment">Audience_Segment</h2><table><tr><th>Column
#' name</th><th>Type</th><th>Description</th></tr><tr><td>CategoryIds</td><td><code>Set
#' of number</code></td><td>The ids of the categories that this audience
#' segment belongs
#' to.</td></tr><tr><td>Id</td><td><code>Number</code></td><td>The unique
#' identifier for the audience
...
#' id="Proposal_Retraction_Reason">Proposal_Retraction_Reason</h2><table><tr><th>Column
#' name</th><th>Type</th><th>Description</th></tr><tr><td>Id</td><td><code>Number</code></td><td>The
...
#' id="Audience_Explorer">Audience_Explorer</h2><table><tr><th>Column
#' name</th><th>Type</th><th>Description</th></tr><tr><td>Id</td><td><code>Number</code></td><td>Uniquely
...
#' days.</td></tr></table><h2
#' id="Time_Zone">Time_Zone</h2><table><tr><th>Column
#' name</th><th>Type</th><th>Description</th></tr><tr><td>Id</td><td><code>Text</code></td><td>The
#' id of time zone in the form of
#' America/New_York.</td></tr><tr><td>StandardGmtOffset</td><td><code>Text</code></td><td>The
#' standard GMT offset in current time in the form of GMT-05:00 for
#' America/New_York, excluding the Daylight Saving Time.</td></tr></table><h2
#' id="Proposal_Terms_And_Conditions">Proposal_Terms_And_Conditions</h2><table><tr><th>Column
#' name</th><th>Type</th><th>Description</th></tr><tr><td>Content</td><td><code>Text</code></td><td>The
#' content of the terms and
#' conditions.</td></tr><tr><td>Id</td><td><code>Number</code></td><td>Uniquely
#' identifies the terms and
#' conditions.</td></tr><tr><td>IsDefault</td><td><code>Boolean</code></td><td>Whether
#' or not this set of terms and conditions are the default for a
#' network.</td></tr><tr><td>LastModifiedDateTime</td><td><code>Datetime</code></td><td>The
#' date and time this terms and conditions was last
#' modified.</td></tr><tr><td>Name</td><td><code>Text</code></td><td>The name
#' of the terms and conditions.</td></tr></table>
#' 
#' select
#' 
