...
#' 
#' ForecastService Object Factory
#' 
#' A function to create a variety of objects that are part of the ForecastService
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.AdUnitAfcSizeError}{Google Documentation for AdUnitAfcSizeError}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.AdUnitCodeError}{Google Documentation for AdUnitCodeError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.AdUnitTargeting}{Google Documentation for AdUnitTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ApiError}{Google Documentation for ApiError}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ApiException}{Google Documentation for ApiException}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ApiVersionError}{Google Documentation for ApiVersionError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ApplicationException}{Google Documentation for ApplicationException}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.AppliedLabel}{Google Documentation for AppliedLabel}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.AudienceExtensionError}{Google Documentation for AudienceExtensionError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.AudienceSegmentCriteria}{Google Documentation for AudienceSegmentCriteria}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.AudienceSegmentError}{Google Documentation for AudienceSegmentError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.AuthenticationError}{Google Documentation for AuthenticationError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' From least to most, these are: <dl> Available units -- How many units can be
#' booked without affecting any other line items. Booking more than this number
#' can cause lower and same priority line items to underdeliver. Possible units
#' -- How many units can be booked without affecting any higher priority line
#' items. Booking more than this number can cause the line item to
#' underdeliver. Matched (forecast) units -- How many units satisfy all
#' specified criteria. </dl> Underdelivery is caused by overbooking. However,
#' if more impressions are served than are predicted, the extra available
#' inventory might enable all inventory guarantees to be met without
#' overbooking.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.AvailabilityForecast}{Google Documentation for AvailabilityForecast}
#' \describe{
#'  \item{lineItemId}{a integer -  Uniquely identifies this availability forecast. This value is read-only and
#' is assigned by Google when the forecast is created. The attribute will be
#' either the ID of the LineItem object it represents, or null if the forecast
#' represents a prospective line item.}
#'  \item{orderId}{a integer -  The unique ID for the Order object that this line item belongs to, or null
#' if the forecast represents a prospective line item without an LineItem
#' orderId set.}
#'  \item{unitType}{a UnitType - The unit with which the goal or cap of the LineItem is defined. Will be the
#' same value as Goal unitType for both a set line item or a prospective one. This can take one of the following values:
#'    \itemize{
...
#'    }
#'   }
#'  \item{availableUnits}{a integer -  The number of units, defined by Goal unitType, that can be booked without
#' affecting the delivery of any reserved line items. Exceeding this value will
#' not cause an overbook, but lower priority line items may not run.}
#'  \item{deliveredUnits}{a integer -  The number of units, defined by Goal unitType, that have already been served
#' if the reservation is already running.}
#'  \item{matchedUnits}{a integer -  The number of units, defined by Goal unitType, that match the specified
#' targeting and delivery settings.}
#'  \item{possibleUnits}{a integer -  The maximum number of units, defined by Goal unitType, that could be booked
#' by taking inventory away from lower priority line items and some same
#' priority line items. Please note: booking this number may cause lower
#' priority line items and some same priority line items to underdeliver.}
#'  \item{reservedUnits}{a integer -  The number of reserved units, defined by Goal unitType, requested. This can
#' be an absolute or percentage value.}
#'  \item{targetingCriteriaBreakdowns}{a TargetingCriteriaBreakdown -  The forecast result broken down by the targeting of the forecasted line
#' item.}
#'  \item{contendingLineItems}{a ContendingLineItem -  List of ContendingLineItem contending line items for this forecast.}
#'  \item{demographicBreakdowns}{a GrpDemographicBreakdown -  The forecast result broken down by demographics.}
#' }
#' 
#' \strong{AvailabilityForecastOptions}
#' 
#' Forecasting options for line item availability forecasts.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.AvailabilityForecastOptions}{Google Documentation for AvailabilityForecastOptions}
#' \describe{
#'  \item{includeTargetingCriteriaBreakdown}{a boolean -  When specified, forecast result for the availability line item will also
#' include breakdowns by its targeting in AvailabilityForecast
#' targetingCriteriaBreakdowns.}
#'  \item{includeContendingLineItems}{a boolean -  When specified, the forecast result for the availability line item will also
#' include contending line items in AvailabilityForecast contendingLineItems.}
#' }
#' 
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.BandwidthGroup}{Google Documentation for BandwidthGroup}
#' \describe{
...
#' LineItem.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.BandwidthGroupTargeting}{Google Documentation for BandwidthGroupTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.BaseCustomFieldValue}{Google Documentation for BaseCustomFieldValue}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.BooleanValue}{Google Documentation for BooleanValue}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.Browser}{Google Documentation for Browser}
#' \describe{
#'  \item{id}{a integer (inherited from Technology) -  The unique ID of the Technology. This value is required for all forms of
#' TechnologyTargeting.}
#'  \item{name}{a string (inherited from Technology) -  The name of the technology being targeting. This value is read-only and is
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.BrowserLanguage}{Google Documentation for BrowserLanguage}
#' \describe{
#'  \item{id}{a integer (inherited from Technology) -  The unique ID of the Technology. This value is required for all forms of
#' TechnologyTargeting.}
#'  \item{name}{a string (inherited from Technology) -  The name of the technology being targeting. This value is read-only and is
...
#' LineItem.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.BrowserLanguageTargeting}{Google Documentation for BrowserLanguageTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.BrowserTargeting}{Google Documentation for BrowserTargeting}
#' \describe{
...
#' described below.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ClickTrackingLineItemError}{Google Documentation for ClickTrackingLineItemError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CollectionSizeError}{Google Documentation for CollectionSizeError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CommonError}{Google Documentation for CommonError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CompanyCreditStatusError}{Google Documentation for CompanyCreditStatusError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' }
#' 
#' \strong{ContendingLineItem}
#' 
#' Describes contending line items for a Forecast.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ContendingLineItem}{Google Documentation for ContendingLineItem}
#' \describe{
#'  \item{lineItemId}{a integer -  The LineItem id Id of the contending line item.}
#'  \item{contendingImpressions}{a integer -  Number of impressions contended for by both the forecasted line item and
#' this line item, but served to this line item in the forecast simulation.}
#' }
#' 
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ContentMetadataKeyHierarchyTargeting}{Google Documentation for ContentMetadataKeyHierarchyTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ContentMetadataTargetingError}{Google Documentation for ContentMetadataTargetingError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ContentTargeting}{Google Documentation for ContentTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CreativeError}{Google Documentation for CreativeError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' VIDEO_PLAYER.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CreativePlaceholder}{Google Documentation for CreativePlaceholder}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CreativeTargeting}{Google Documentation for CreativeTargeting}
#' \describe{
#'  \item{name}{a string -  The name of this creative targeting. This attribute is required.}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CrossSellError}{Google Documentation for CrossSellError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CustomCriteria}{Google Documentation for CustomCriteria}
#' \describe{
#'  \item{extends CustomCriteriaLeaf}{see documentation for CustomCriteriaLeaf}
...
#' structure.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CustomCriteriaLeaf}{Google Documentation for CustomCriteriaLeaf}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CustomCriteriaNode}{Google Documentation for CustomCriteriaNode}
#' \describe{
#' }
#' 
...
#' customTargeting.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CustomCriteriaSet}{Google Documentation for CustomCriteriaSet}
#' \describe{
#'  \item{extends CustomCriteriaNode}{see documentation for CustomCriteriaNode}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CustomFieldValue}{Google Documentation for CustomFieldValue}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CustomFieldValueError}{Google Documentation for CustomFieldValueError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' objects.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.CustomTargetingError}{Google Documentation for CustomTargetingError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' 
#' Represents a date.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.Date}{Google Documentation for Date}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DateTime}{Google Documentation for DateTime}
#' \describe{
#'  \item{date}{a Date}
#'  \item{hour}{a integer}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DateTimeRangeTargetingError}{Google Documentation for DateTimeRangeTargetingError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DateTimeValue}{Google Documentation for DateTimeValue}
#' \describe{
#'  \item{extends Value}{see documentation for Value}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DateValue}{Google Documentation for DateValue}
#' \describe{
#'  \item{extends Value}{see documentation for Value}
...
#' by a LineItem.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DayPart}{Google Documentation for DayPart}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DayPartTargeting}{Google Documentation for DayPartTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DayPartTargetingError}{Google Documentation for DayPartTargetingError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DeliveryData}{Google Documentation for DeliveryData}
#' \describe{
#'  \item{units}{a integer -  Clicks or impressions delivered for the last 7 days.}
#' }
#' 
#' \strong{DeliveryForecast}
#' 
#' The forecast of delivery for a list of ProspectiveLineItem objects to be
#' reserved at the same time.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DeliveryForecast}{Google Documentation for DeliveryForecast}
#' \describe{
#'  \item{lineItemDeliveryForecasts}{a LineItemDeliveryForecast -  The delivery forecasts of the forecasted line items.}
#' }
#' 
#' \strong{DeliveryForecastOptions}
#' 
#' Forecasting options for line item delivery forecasts.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DeliveryForecastOptions}{Google Documentation for DeliveryForecastOptions}
#' \describe{
#'  \item{ignoredLineItemIds}{a integer -  Line item IDs to be ignored while performing the delivery simulation.}
#' }
#' 
#' \strong{DeliveryIndicator}
#' 
#' Indicates the delivery performance of the LineItem.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DeliveryIndicator}{Google Documentation for DeliveryIndicator}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DeviceCapability}{Google Documentation for DeviceCapability}
#' \describe{
#'  \item{id}{a integer (inherited from Technology) -  The unique ID of the Technology. This value is required for all forms of
#' TechnologyTargeting.}
#'  \item{name}{a string (inherited from Technology) -  The name of the technology being targeting. This value is read-only and is
...
#' LineItem.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DeviceCapabilityTargeting}{Google Documentation for DeviceCapabilityTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DeviceCategory}{Google Documentation for DeviceCategory}
#' \describe{
#'  \item{id}{a integer (inherited from Technology) -  The unique ID of the Technology. This value is required for all forms of
#' TechnologyTargeting.}
#'  \item{name}{a string (inherited from Technology) -  The name of the technology being targeting. This value is read-only and is
...
#' LineItem.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DeviceCategoryTargeting}{Google Documentation for DeviceCategoryTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DeviceManufacturer}{Google Documentation for DeviceManufacturer}
#' \describe{
#'  \item{id}{a integer (inherited from Technology) -  The unique ID of the Technology. This value is required for all forms of
#' TechnologyTargeting.}
#'  \item{name}{a string (inherited from Technology) -  The name of the technology being targeting. This value is read-only and is
...
#' LineItem.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DeviceManufacturerTargeting}{Google Documentation for DeviceManufacturerTargeting}
#' \describe{
...
#' CustomFieldDataType DROP_DOWN
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.DropDownCustomFieldValue}{Google Documentation for DropDownCustomFieldValue}
#' \describe{
#'  \item{customFieldId}{a integer (inherited from BaseCustomFieldValue) -  Id of the CustomField to which this value belongs. This attribute is
#' required.}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.EntityChildrenLimitReachedError}{Google Documentation for EntityChildrenLimitReachedError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.EntityLimitReachedError}{Google Documentation for EntityLimitReachedError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.FeatureError}{Google Documentation for FeatureError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ForecastError}{Google Documentation for ForecastError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.FrequencyCap}{Google Documentation for FrequencyCap}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.FrequencyCapError}{Google Documentation for FrequencyCapError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.GenericTargetingError}{Google Documentation for GenericTargetingError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.GeoTargeting}{Google Documentation for GeoTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.GeoTargetingError}{Google Documentation for GeoTargetingError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.Goal}{Google Documentation for Goal}
#' \describe{
...
#' }
#' 
#' \strong{GrpDemographicBreakdown}
#' 
#' GRP forecast breakdown counts associated with a gender and age demographic.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.GrpDemographicBreakdown}{Google Documentation for GrpDemographicBreakdown}
#' \describe{
#'  \item{availableUnits}{a integer -  The number of units matching the demographic breakdown that can be booked
#' without affecting the delivery of any reserved line items.}
#'  \item{matchedUnits}{a integer -  The number of units matching the demographic and matching specified
#' targeting and delivery settings.}
#'  \item{unitType}{a GrpUnitType - The GrpUnitType associated with this demographic breakdown. This can take one of the following values:
#'    \itemize{
#'      \item{UNKNOWN - The value returned if the actual value is not exposed by the requested API
#' version.}
#'      \item{IMPRESSIONS}
#'    }
#'   }
#'  \item{gender}{a GrpGender - The GrpGender associated with this demographic breakdown. This can take one of the following values:
#'    \itemize{
#'      \item{UNKNOWN - The value returned if the actual value is not exposed by the requested API
#' version.}
#'      \item{GENDER_UNKNOWN - When gender is not available due to low impression levels, GRP privacy
#' thresholds are activated and prevent us from specifying gender.}
#'      \item{GENDER_FEMALE}
#'      \item{GENDER_MALE}
#'    }
#'   }
#'  \item{age}{a GrpAge - The GrpAge associated with this demographic breakdown. This can take one of the following values:
#'    \itemize{
#'      \item{UNKNOWN - The value returned if the actual value is not exposed by the requested API
#' version.}
#'      \item{AGE_UNKNOWN - When the age range is not available due to low impression levels, GRP
#' privacy thresholds are activated and prevent us from specifying age.}
#'      \item{AGE_0_TO_17}
#'      \item{AGE_18_TO_24}
#'      \item{AGE_25_TO_34}
#'      \item{AGE_35_TO_44}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.GrpSettings}{Google Documentation for GrpSettings}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.GrpSettingsError}{Google Documentation for GrpSettingsError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ImageError}{Google Documentation for ImageError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' client.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.InternalApiError}{Google Documentation for InternalApiError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.InvalidUrlError}{Google Documentation for InvalidUrlError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.InventoryTargeting}{Google Documentation for InventoryTargeting}
#' \describe{
...
#' targeting expression.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.InventoryTargetingError}{Google Documentation for InventoryTargetingError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.InventoryUnitError}{Google Documentation for InventoryUnitError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.LabelEntityAssociationError}{Google Documentation for LabelEntityAssociationError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.LineItem}{Google Documentation for LineItem}
#' \describe{
...
#'  \item{name}{a string (inherited from LineItemSummary) -  The name of the line item. This attribute is required and has a maximum
#' length of 255 characters.}
#'  \item{externalId}{a string (inherited from LineItemSummary) -  An identifier for the LineItem that is meaningful to the publisher. This
#' attribute is optional and has a maximum length of 63 characters.}
#'  \item{orderName}{a string (inherited from LineItemSummary) -  The name of the Order. This value is read-only.}
...
#'  \item{webPropertyCode}{a string (inherited from LineItemSummary) -  The web property code used for dynamic allocation line items. This web
...
#'  \item{lastModifiedByApp}{a string (inherited from LineItemSummary) -  The application that last modified this line item. This attribute is read
#' only and is assigned by Google.}
#'  \item{notes}{a string (inherited from LineItemSummary) -  Provides any additional notes that may annotate the LineItem. This attribute
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.LineItemActivityAssociation}{Google Documentation for LineItemActivityAssociation}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.LineItemActivityAssociationError}{Google Documentation for LineItemActivityAssociationError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.LineItemCreativeAssociationError}{Google Documentation for LineItemCreativeAssociationError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' }
#' 
#' \strong{LineItemDeliveryForecast}
#' 
#' The forecasted delivery of a ProspectiveLineItem.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.LineItemDeliveryForecast}{Google Documentation for LineItemDeliveryForecast}
#' \describe{
#'  \item{lineItemId}{a integer -  Uniquely identifies this line item delivery forecast. This value is
#' read-only and will be either the ID of the LineItem object it represents, or
...
#'    }
#'   }
#'  \item{predictedDeliveryUnits}{a integer -  The number of units, defined by Goal unitType, that will be delivered by the
#' line item. Delivery of existing line items that are of same or lower
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.LineItemError}{Google Documentation for LineItemError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.LineItemFlightDateError}{Google Documentation for LineItemFlightDateError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.LineItemOperationError}{Google Documentation for LineItemOperationError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' derived.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.LineItemSummary}{Google Documentation for LineItemSummary}
#' \describe{
...
#' assigned by Google when a line item is created.}
#'  \item{name}{a string -  The name of the line item. This attribute is required and has a maximum
#' length of 255 characters.}
#'  \item{externalId}{a string -  An identifier for the LineItem that is meaningful to the publisher. This
#' attribute is optional and has a maximum length of 63 characters.}
#'  \item{orderName}{a string -  The name of the Order. This value is read-only.}
...
#'  \item{webPropertyCode}{a string -  The web property code used for dynamic allocation line items. This web
#' property is only required with line item types LineItemType AD_EXCHANGE and
#' LineItemType ADSENSE.}
...
#' to true will allow line items from the same advertiser to serve regardless
#' of the other competitive exclusion labels being applied.}
#'  \item{lastModifiedByApp}{a string -  The application that last modified this line item. This attribute is read
#' only and is assigned by Google.}
#'  \item{notes}{a string -  Provides any additional notes that may annotate the LineItem. This attribute
#' is optional and has a maximum length of 65,535 characters.}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.Location}{Google Documentation for Location}
#' \describe{
...
#' mobile publishers.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.MobileCarrier}{Google Documentation for MobileCarrier}
#' \describe{
#'  \item{id}{a integer (inherited from Technology) -  The unique ID of the Technology. This value is required for all forms of
#' TechnologyTargeting.}
#'  \item{name}{a string (inherited from Technology) -  The name of the technology being targeting. This value is read-only and is
...
#' LineItem.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.MobileCarrierTargeting}{Google Documentation for MobileCarrierTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.MobileDevice}{Google Documentation for MobileDevice}
#' \describe{
#'  \item{id}{a integer (inherited from Technology) -  The unique ID of the Technology. This value is required for all forms of
#' TechnologyTargeting.}
#'  \item{name}{a string (inherited from Technology) -  The name of the technology being targeting. This value is read-only and is
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.MobileDeviceSubmodel}{Google Documentation for MobileDeviceSubmodel}
#' \describe{
#'  \item{id}{a integer (inherited from Technology) -  The unique ID of the Technology. This value is required for all forms of
#' TechnologyTargeting.}
#'  \item{name}{a string (inherited from Technology) -  The name of the technology being targeting. This value is read-only and is
...
#' LineItem.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.MobileDeviceSubmodelTargeting}{Google Documentation for MobileDeviceSubmodelTargeting}
#' \describe{
...
#' Represents mobile devices that are being targeted or excluded by the
#' LineItem.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.MobileDeviceTargeting}{Google Documentation for MobileDeviceTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.Money}{Google Documentation for Money}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.NotNullError}{Google Documentation for NotNullError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.NullError}{Google Documentation for NullError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.NumberValue}{Google Documentation for NumberValue}
#' \describe{
#'  \item{extends Value}{see documentation for Value}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ObjectValue}{Google Documentation for ObjectValue}
#' \describe{
#'  \item{extends Value}{see documentation for Value}
#' }
#' 
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.OperatingSystem}{Google Documentation for OperatingSystem}
#' \describe{
#'  \item{id}{a integer (inherited from Technology) -  The unique ID of the Technology. This value is required for all forms of
#' TechnologyTargeting.}
#'  \item{name}{a string (inherited from Technology) -  The name of the technology being targeting. This value is read-only and is
...
#' LineItem.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.OperatingSystemTargeting}{Google Documentation for OperatingSystemTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.OperatingSystemVersion}{Google Documentation for OperatingSystemVersion}
#' \describe{
#'  \item{id}{a integer (inherited from Technology) -  The unique ID of the Technology. This value is required for all forms of
#' TechnologyTargeting.}
#'  \item{name}{a string (inherited from Technology) -  The name of the technology being targeting. This value is read-only and is
...
#' the LineItem.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.OperatingSystemVersionTargeting}{Google Documentation for OperatingSystemVersionTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.OrderActionError}{Google Documentation for OrderActionError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.OrderError}{Google Documentation for OrderError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ParseError}{Google Documentation for ParseError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.PermissionError}{Google Documentation for PermissionError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ProgrammaticError}{Google Documentation for ProgrammaticError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' }
#' 
#' \strong{ProspectiveLineItem}
#' 
#' Represents a prospective line item to be forecasted.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ProspectiveLineItem}{Google Documentation for ProspectiveLineItem}
#' \describe{
#'  \item{lineItem}{a LineItem -  The target of the forecast. If LineItem id is null or no line item exists
#' with that ID, then a forecast is computed for the the subject, predicting
#' what would happen if it were added to the network. If a line item already
#' exists with LineItem id, the forecast is computed for the subject,
#' predicting what would happen if the existing line item's settings were
#' modified to match the subject.}
#'  \item{advertiserId}{a integer -  When set, the line item is assumed to be from this advertiser, and unified
#' blocking rules will apply accordingly. If absent, line items without an
#' existing order won't be subject to unified blocking rules.}
#' }
#' 
...
#' object.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.PublisherQueryLanguageContextError}{Google Documentation for PublisherQueryLanguageContextError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' object.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.PublisherQueryLanguageSyntaxError}{Google Documentation for PublisherQueryLanguageSyntaxError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.QuotaError}{Google Documentation for QuotaError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.RangeError}{Google Documentation for RangeError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.RegExError}{Google Documentation for RegExError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.RequiredCollectionError}{Google Documentation for RequiredCollectionError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.RequiredError}{Google Documentation for RequiredError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' validators.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.RequiredNumberError}{Google Documentation for RequiredNumberError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.RequiredSizeError}{Google Documentation for RequiredSizeError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ReservationDetailsError}{Google Documentation for ReservationDetailsError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.ServerError}{Google Documentation for ServerError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.SetTopBoxInfo}{Google Documentation for SetTopBoxInfo}
#' \describe{
...
#'    }
#'   }
#'  \item{lastSyncCanoeResponseMessage}{a string -  The response that Canoe sent for the last sync attempt. This attribute is
#' read-only.}
#'  \item{nielsenProductCategoryCode}{a string -  The Nielsen product category code for the line item.}
#' }
#' 
#' \strong{SetTopBoxLineItemError}
#' 
#' Errors associated with set-top box LineItem line items.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.SetTopBoxLineItemError}{Google Documentation for SetTopBoxLineItemError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.SetValue}{Google Documentation for SetValue}
#' \describe{
#'  \item{extends Value}{see documentation for Value}
...
#' be 1x1.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.Size}{Google Documentation for Size}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.SoapRequestHeader}{Google Documentation for SoapRequestHeader}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.SoapResponseHeader}{Google Documentation for SoapResponseHeader}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.StatementError}{Google Documentation for StatementError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.Stats}{Google Documentation for Stats}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.StringLengthError}{Google Documentation for StringLengthError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.Targeting}{Google Documentation for Targeting}
#' \describe{
...
#' }
#' 
#' \strong{TargetingCriteriaBreakdown}
#' 
#' A single targeting criteria breakdown result.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.TargetingCriteriaBreakdown}{Google Documentation for TargetingCriteriaBreakdown}
#' \describe{
#'  \item{targetingDimension}{a TargetingDimension - The dimension of this breakdown This can take one of the following values:
#'    \itemize{
#'      \item{CUSTOM_CRITERIA}
#'      \item{GEOGRAPHY}
#'      \item{BROWSER}
...
#'    }
#'   }
#'  \item{targetingCriteriaId}{a integer -  The unique ID of the targeting criteria.}
#'  \item{targetingCriteriaName}{a string -  The name of the targeting criteria.}
#'  \item{excluded}{a boolean -  When true, the breakdown is negative.}
#'  \item{availableUnits}{a integer -  The available units for this breakdown.}
#'  \item{matchedUnits}{a integer -  The matched units for this breakdown.}
#' }
#' 
#' \strong{TeamError}
#' 
#' Errors related to a Team.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.TeamError}{Google Documentation for TeamError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.Technology}{Google Documentation for Technology}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.TechnologyTargeting}{Google Documentation for TechnologyTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.TechnologyTargetingError}{Google Documentation for TechnologyTargetingError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.TextValue}{Google Documentation for TextValue}
#' \describe{
#'  \item{extends Value}{see documentation for Value}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.TimeOfDay}{Google Documentation for TimeOfDay}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.TimeZoneError}{Google Documentation for TimeZoneError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.TypeError}{Google Documentation for TypeError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
#' }
#' 
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.UniqueError}{Google Documentation for UniqueError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
#' }
#' 
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.UserDomainTargeting}{Google Documentation for UserDomainTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.UserDomainTargetingError}{Google Documentation for UserDomainTargetingError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.Value}{Google Documentation for Value}
#' \describe{
#' }
#' 
...
#' mid-roll index.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.VideoPosition}{Google Documentation for VideoPosition}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.VideoPositionTarget}{Google Documentation for VideoPositionTarget}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.VideoPositionTargeting}{Google Documentation for VideoPositionTargeting}
#' \describe{
...
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.VideoPositionTargetingError}{Google Documentation for VideoPositionTargetingError}
#' \describe{
#'  \item{extends ApiError}{see documentation for ApiError}
...
#' position.
#' \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201508/ForecastService.VideoPositionWithinPod}{Google Documentation for VideoPositionWithinPod}
#' \describe{
...
#' 
#' 
#' @usage dfp_ForecastService_object_factory(obj_type, obj_data)
#' 
...
#' @export
dfp_ForecastService_object_factory <- function(obj_type, obj_data){
  ...
  if(obj_type=='AvailabilityForecast'){
    stopifnot(all(sampled_names %in% c('lineItemId', 'orderId', 'unitType', 'availableUnits', 'deliveredUnits', 'matchedUnits', 'possibleUnits', 'reservedUnits', 'targetingCriteriaBreakdowns', 'contendingLineItems', 'demographicBreakdowns')))
  }

  if(obj_type=='AvailabilityForecastOptions'){
    stopifnot(all(sampled_names %in% c('includeTargetingCriteriaBreakdown', 'includeContendingLineItems')))
  }
  ...
  if(obj_type=='DeliveryForecast'){
    stopifnot(all(sampled_names %in% c('lineItemDeliveryForecasts')))
  }

  if(obj_type=='DeliveryForecastOptions'){
    stopifnot(all(sampled_names %in% c('ignoredLineItemIds')))
  }
  ...
  if(obj_type=='GrpDemographicBreakdown'){
    stopifnot(all(sampled_names %in% c('availableUnits', 'matchedUnits', 'unitType', 'gender', 'age')))
  }
  ...
  if(obj_type=='TargetingCriteriaBreakdown'){
