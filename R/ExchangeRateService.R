...
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a createExchangeRatesResponse
#' @export
...
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a getExchangeRatesByStatementResponse
#' @export
...
#' @export
dfp_performExchangeRateAction <- function(){

  request_body <- make_request_body(service='ExchangeRateService', root_name='performExchangeRateAction', data=NULL)
  request <- build_soap_request(body = request_body)
...
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a updateExchangeRatesResponse
#' @export
