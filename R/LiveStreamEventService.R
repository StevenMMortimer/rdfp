...
#' 
#' @usage dfp_createLiveStreamEvents(request_data, as_df=FALSE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a createLiveStreamEventsResponse 
#' @export
dfp_createLiveStreamEvents <- function(request_data, as_df=FALSE){
...
#' 
#' @usage dfp_getLiveStreamEventsByStatement(request_data, as_df=FALSE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a getLiveStreamEventsByStatementResponse 
#' @export
dfp_getLiveStreamEventsByStatement <- function(request_data, as_df=FALSE){
...
#' 
#' @usage dfp_performLiveStreamEventAction(request_data, as_df=FALSE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a performLiveStreamEventActionResponse 
#' @export
dfp_performLiveStreamEventAction <- function(request_data, as_df=FALSE){
...
#' 
#' @usage dfp_updateLiveStreamEvents(request_data, as_df=FALSE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a updateLiveStreamEventsResponse 
#' @export
dfp_updateLiveStreamEvents <- function(request_data, as_df=FALSE){
