...
#' assigned by Google.}
#'  \item{name}{a character - The name of the AdExclusionRule. This attribute is required.}
...
#' 
#' @usage dfp_createAdExclusionRules(request_data, as_df=FALSE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a createAdExclusionRulesResponse 
#' @export
dfp_createAdExclusionRules <- function(request_data, as_df=FALSE){
...
#' 
#' @usage dfp_getAdExclusionRulesByStatement(request_data, as_df=FALSE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a getAdExclusionRulesByStatementResponse 
#' @export
dfp_getAdExclusionRulesByStatement <- function(request_data, as_df=FALSE){
...
#' 
#' @usage dfp_performAdExclusionRuleAction(request_data, as_df=FALSE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a performAdExclusionRuleActionResponse 
#' @export
dfp_performAdExclusionRuleAction <- function(request_data, as_df=FALSE){
...
#' 
#' @usage dfp_updateAdExclusionRules(request_data, as_df=FALSE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a updateAdExclusionRulesResponse 
#' @export
dfp_updateAdExclusionRules <- function(request_data, as_df=FALSE){
