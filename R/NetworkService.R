...
#' 
#' @usage dfp_getAllNetworks(as_df=FALSE)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a getAllNetworksResponse 
#' @export
dfp_getAllNetworks <- function(as_df=FALSE){
...
#' 
#' @usage dfp_getCurrentNetwork(as_df=FALSE)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a getCurrentNetworkResponse 
#' @export
dfp_getCurrentNetwork <- function(as_df=FALSE){
...
#' 
#' @usage dfp_makeTestNetwork(as_df=FALSE)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a makeTestNetworkResponse 
#' @export
dfp_makeTestNetwork <- function(as_df=FALSE){
...
#' 
#' @usage dfp_updateNetwork(request_data, as_df=FALSE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a updateNetworkResponse 
#' @export
dfp_updateNetwork <- function(request_data, as_df=FALSE){
