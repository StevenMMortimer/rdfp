...
#' }
#' 
#' @seealso \href{https://developers.google.com/doubleclick-publishers/docs/reference/v201802/LineItemTemplateService#getLineItemTemplatesByStatement}{Google Documentation for getLineItemTemplatesByStatement}
#' 
...
dfp_getLineItemTemplatesByStatement <- function(request_data, as_df=TRUE, verbose=FALSE){
  ...
  result <- parse_soap_response(httr_response=response, resp_element='getLineItemTemplatesByStatementResponse', as_df=as_df)
  return(result)
}
#' 
