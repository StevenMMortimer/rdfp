...
#' 
#' @usage dfp_getProductsByStatement(request_data, as_df=TRUE)
...
#' @export
dfp_getProductsByStatement <- function(request_data, as_df=TRUE){
...
#' 
#' @usage dfp_performProductAction(request_data, as_df=TRUE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{data.frame} or \code{list} containing all the elements of a performProductActionResponse 
#' @export
dfp_performProductAction <- function(request_data, as_df=TRUE){
...
#' 
#' @usage dfp_updateProducts(request_data, as_df=TRUE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{data.frame} or \code{list} containing all the elements of a updateProductsResponse 
#' @export
dfp_updateProducts <- function(request_data, as_df=TRUE){
