...
#' Google.}
#'  \item{name}{a string -  The name of the contact. This attribute is required and has a maximum length
#' of 127 characters.}
...
#'    }
#'   }
#'  \item{address}{a string -  The address of the contact. This attribute is optional and has a maximum
#' length of 1024 characters.}
#'  \item{cellPhone}{a string -  The cell phone number where the contact can be reached. This attribute is
#' optional.}
#'  \item{comment}{a string -  A free-form text comment for the contact. This attribute is optional and has
#' a maximum length of 1024 characters.}
#'  \item{email}{a string -  The e-mail address where the contact can be reached. This attribute is
#' optional.}
#'  \item{faxPhone}{a string -  The fax number where the contact can be reached. This attribute is optional.}
#'  \item{title}{a string -  The job title of the contact. This attribute is optional and has a maximum
#' length of 1024 characters.}
#'  \item{workPhone}{a string -  The work phone number where the contact can be reached. This attribute is
#' optional.}
#' }
#' 
#' \strong{ContactError}
...
dfp_ContactService_object_factory <- function(obj_type, obj_data){
  ...
  if(obj_type=='ContactError'){
    stopifnot(all(sampled_names %in% c('reason')))
  }

  if(obj_type=='ContactPage'){
...
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a createContactsResponse
#' @export
dfp_createContacts <- function(request_data){
  ...
  response <- xmlChildren(xmlChildren(xmlChildren(xmlRoot(request))$Body)[['createContactsResponse']])$rval
...
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a getContactsByStatementResponse
#' @export
dfp_getContactsByStatement <- function(request_data){
  ...
  response <- xmlChildren(xmlChildren(xmlChildren(xmlRoot(request))$Body)[['getContactsByStatementResponse']])$rval
  response <- if(is.null(response)) NULL else xmlToList(response)
  return(response)
}
#' 
...
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a updateContactsResponse
#' @export
dfp_updateContacts <- function(request_data){
  ...
  response <- xmlChildren(xmlChildren(xmlChildren(xmlRoot(request))$Body)[['updateContactsResponse']])$rval
  response <- if(is.null(response)) NULL else xmlToList(response)
  return(response)
}
#' 
