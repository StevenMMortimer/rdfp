...
dfp_ProductPackageItemService_object_factory <- function(obj_type, obj_data){
  ...
  if(obj_type=='ProductPackageItemActionError'){
    stopifnot(all(sampled_names %in% c('reason')))
  }
  ...
  if(obj_type=='ProductPackageItemPage'){
...
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a createProductPackageItemsResponse
#' @export
...
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a getProductPackageItemsByStatementResponse
#' @export
...
#' @export
dfp_performProductPackageItemAction <- function(){

  request_body <- make_request_body(service='ProductPackageItemService', root_name='performProductPackageItemAction', data=NULL)
  request <- build_soap_request(body = request_body)
...
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a updateProductPackageItemsResponse
#' @export
