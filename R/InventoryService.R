...
#'  \item{borderColor}{a character - Specifies the Hexadecimal border color, from 000000 to FFFFFF. This
...
#'  \item{titleColor}{a character - Specifies the Hexadecimal title color of an ad, from 000000 to FFFFFF. This
#' attribute is optional and defaults to the ad unit's parent or ancestor's
#' setting if one has been set. If no ancestor of the ad unit has set
#' titleColor, the attribute is defaulted to 0000FF.}
#'  \item{backgroundColor}{a character - Specifies the Hexadecimal background color of an ad, from 000000 to FFFFFF.
...
#'  \item{textColor}{a character - Specifies the Hexadecimal color of the text of an ad, from 000000 to FFFFFF.
#' This attribute is optional and defaults to the ad unit's parent or
#' ancestor's setting if one has been set. If no ancestor of the ad unit has
#' set textColor, the attribute is defaulted to 000000.}
#'  \item{urlColor}{a character - Specifies the Hexadecimal color of the URL of an ad, from 000000 to FFFFFF.
#' This attribute is optional and defaults to the ad unit's parent or
#' ancestor's setting if one has been set. If no ancestor of the ad unit has
...
#' \describe{
#'  \item{id}{a character - Uniquely identifies the AdUnit. This value is read-only and is assigned by
#' Google when an ad unit is created. This attribute is required for updates.}
#'  \item{parentId}{a character - The ID of the ad unit's parent. Every ad unit has a parent except for the
...
#'  \item{name}{a character - The name of the ad unit. This attribute is required and its maximum length
...
#'  \item{description}{a character - A description of the ad unit. This value is optional and its maximum length
...
#' read-only.}
#'  \item{externalSetTopBoxChannelId}{a character - Specifies an ID for a channel in an external set-top box campaign management
...
#' \describe{
#'  \item{networkName}{a character - The name of the distributor network sharing its ad unit with the active
...
#' 
#' @usage dfp_createAdUnits(request_data, as_df=TRUE)
...
#' @export
dfp_createAdUnits <- function(request_data, as_df=TRUE){
...
#' 
#' @usage dfp_performAdUnitAction(request_data, as_df=TRUE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{data.frame} or \code{list} containing all the elements of a performAdUnitActionResponse 
#' @export
dfp_performAdUnitAction <- function(request_data, as_df=TRUE){
...
#' 
#' @usage dfp_updateAdUnits(request_data, as_df=TRUE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{data.frame} or \code{list} containing all the elements of a updateAdUnitsResponse 
#' @export
dfp_updateAdUnits <- function(request_data, as_df=TRUE){
