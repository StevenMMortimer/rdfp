...
#' and is read-only.}
#'  \item{comments}{a character - The comments for this row. This attribute is optional.}
#' }
#' 
...
#' 
#' @usage dfp_getReconciliationReportRowsByStatement(request_data, as_df=FALSE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a getReconciliationReportRowsByStatementResponse 
#' @export
dfp_getReconciliationReportRowsByStatement <- function(request_data, as_df=FALSE){
...
#' 
#' @usage dfp_updateReconciliationReportRows(request_data, as_df=FALSE)
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)
#' @param as_df a boolean indicating whether to attempt to parse the result into a \code{data.frame}
#' @return a \code{list} or \code{data.frame} containing all the elements of a updateReconciliationReportRowsResponse 
#' @export
dfp_updateReconciliationReportRows <- function(request_data, as_df=FALSE){
