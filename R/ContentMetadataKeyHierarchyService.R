...
#'  \item{name}{a string -  The unique name of the ContentMetadataKeyHierarchy. This attribute is
...
dfp_ContentMetadataKeyHierarchyService_object_factory <- function(obj_type, obj_data){
  ...
  if(obj_type=='ContentMetadataKeyHierarchyError'){
    stopifnot(all(sampled_names %in% c('reason')))
  }
  ...
  if(obj_type=='ContentMetadataKeyHierarchyPage'){
...
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a createContentMetadataKeyHierarchiesResponse
#' @export
dfp_createContentMetadataKeyHierarchies <- function(request_data){
  ...
  response <- xmlChildren(xmlChildren(xmlChildren(xmlRoot(request))$Body)[['createContentMetadataKeyHierarchiesResponse']])$rval
...
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a getContentMetadataKeyHierarchiesByStatementResponse
#' @export
dfp_getContentMetadataKeyHierarchiesByStatement <- function(request_data){
  ...
  response <- xmlChildren(xmlChildren(xmlChildren(xmlRoot(request))$Body)[['getContentMetadataKeyHierarchiesByStatementResponse']])$rval
  response <- if(is.null(response)) NULL else xmlToList(response)
  return(response)
}
#' 
...
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a updateContentMetadataKeyHierarchiesResponse
#' @export
dfp_updateContentMetadataKeyHierarchies <- function(request_data){
  ...
  response <- xmlChildren(xmlChildren(xmlChildren(xmlRoot(request))$Body)[['updateContentMetadataKeyHierarchiesResponse']])$rval
  response <- if(is.null(response)) NULL else xmlToList(response)
  return(response)
}
#' 
