...
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a createOrdersResponse
#' @export
...
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a getOrdersByStatementResponse
#' @export
...
#' @export
dfp_performOrderAction <- function(){

  request_body <- make_request_body(service='OrderService', root_name='performOrderAction', data=NULL)
  request <- build_soap_request(body = request_body)
...
#' @param request_data a \code{list} or \code{data.frame} of data elements
#' to be formatted for a SOAP request (XML format, but passed as character string)#' @return a \code{list} containing all the elements of a updateOrdersResponse
#' @export
