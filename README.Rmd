...
**rdfp** is the R implementation of DoubleClick for Publishers and similar in comparison to the 
...
functionality up to par with the client libraries. Most all operations supported by the DFP API are 
